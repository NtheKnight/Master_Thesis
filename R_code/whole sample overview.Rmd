...
FOXP3_length$sample <- factor(FOXP3_length$sample,
                              levels=c("HD42_Lib1","HD42_Lib2","HD43","Cases-Treg-HD2","Cases-HD3-Treg-3","Cases_Tconv-7","Cases-HD3-Treg-6","Cases-Treg-5"))
...
FOXP3_counts <- ggplot(count, aes(fill=reads, y=count , x=sample)) + 
  ...
  geom_rect(aes(xmin = 3.5, xmax = 8.5, ymin = -Inf, ymax = Inf), fill = NA, color = "#2ab07f", lwd = 1.5) +
...
FOXP3_readslength_v <- ggplot(whole_FOXP3_readslength, 
                  ...
                  theme(text=element_text(family="serif", size=25))+
                  theme(axis.text.x = element_text(angle = 45, hjust = 1, size=27))+
                  geom_hline(yintercept = 1488, color = "red")+
                  theme(legend.position = "none")
                  #theme(legend.position = "bottom")+
                  #theme(legend.title=element_blank())
...
png(file="Poly(A) length Overview.png", width =1400, height = 1800, units = "px") 
(((FOXP3_v | whole_v | whole_zoom_v ) + 
    plot_layout(guides ="collect")&
        theme(legend.position = 'bottom',
        legend.box = "horizontal"))/
...
png(file="read length Overview.png", width =1400, height = 1800, units = "px") 
...
png(file="read length Overview_Median_average.png", width =1400, height = 1800, units = "px")
(FOXP3_readslength_v)/
(HG38_readslength_v)
dev.off()

png(filename="sample Overview_averagesred_medianblue.png", width =2200, height = 1900, units = "px") 
(((FOXP3_v | whole_v | whole_zoom_v ) + 
    plot_layout(guides ="collect")&
        theme(legend.position = 'bottom',
        legend.box = "horizontal"))/
