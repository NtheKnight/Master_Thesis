...
#sets working DIR
setwd("___/04_Masterarbeit/05_R_Skripte/02_violin_Plots")
datapath <- "___/04_Data/01_Cases"
```
##Violin Plots
...
FOXP3_length <- rbind(FOXP3reads4,FOXP3reads5,FOXP3reads6)#,FOXP3reads1,FOXP3reads2,FOXP3reads3,FOXP3reads7,FOXP3reads8)
  #removes unused data, to save RAM capacity
    rm(FOXP3reads4,FOXP3reads5,FOXP3reads6)#,FOXP3reads1,FOXP3reads2,FOXP3reads3,FOXP3reads7,FOXP3reads8)
#creates violin plots
FOXP3_v <- ggplot(FOXP3_length, aes(x=sample, y=Poly_A_length)) +
            geom_violin(scale = "width", aes(fill =sample))  +
            scale_fill_manual(values=c("#ffee5a", "#ffee5a", "#ffee5a"))+
...
#holereads2<- fread(paste0(datapath, "/01_Cases-HD3-Treg-3/reads.Poly-A.Cases-HD3-Treg-3.txt"), col.names = c('count', 'Poly_A_length'))
...
#combine files to one 
whole_length <- rbind(Wholereads4,Wholereads5,Wholereads6)#,Wholereads1,Wholereads2,Wholereads3,Wholereads7, Wholereads8)
     #removes unused data, to save RAM capacity
        rm(Wholereads4,Wholereads5,Wholereads6)#,Wholereads1,Wholereads2,Wholereads3,Wholereads7, Wholereads8)
#creates violin plots
...
#combine files to one 
count <- rbind(FOXP3counts4,FOXP3counts5,FOXP3counts6)#,FOXP3counts1,FOXP3counts2,FOXP3counts3,FOXP3counts7,FOXP3counts8 )
...
count$count[2] <- FOXP3counts4$count[2]/FOXP3counts4$count[1]
count$count[1] <- 1-count$count[2]
count$count[4] <- FOXP3counts5$count[2]/FOXP3counts5$count[1]
count$count[3] <- 1-count$count[4]
count$count[6] <- FOXP3counts6$count[2]/FOXP3counts6$count[1]
count$count[5] <- 1-count$count[6]
...
#count$count[15] <- 1-count$count[16]
  ...
  #removes unused data, to save RAM capacity
   rm(FOXP3counts4,FOXP3counts5,FOXP3counts6)#,FOXP3counts1,FOXP3counts2,FOXP3counts3,FOXP3counts7,FOXP3counts8 )
...
#combine files to one 
whole_count <- rbind(wholecounts4,wholecounts5,wholecounts6)#,wholecounts1,wholecounts2,wholecounts3,,wholecounts7, wholecounts8)
...
whole_count$count[2] <- wholecounts4$count[2]/wholecounts4$count[1]
whole_count$count[1] <- 1-whole_count$count[2]
whole_count$count[4] <- wholecounts5$count[2]/wholecounts5$count[1]
whole_count$count[3] <- 1-whole_count$count[4]
whole_count$count[6] <- wholecounts6$count[2]/wholecounts6$count[1]
whole_count$count[5] <- 1-whole_count$count[6]
...
#whole_count$count[15] <- 1-whole_count$count[16]
  ...
  #removes unused data, to save RAM capacity
    rm(wholecounts4,wholecounts5,wholecounts6)#,wholecounts1,wholecounts2,wholecounts3,,wholecounts7, wholecounts8)
...
readcomposition_bp <- ggplot(readcomposition_summary, aes(x=sample, y=prop, fill=legend)) +
  ...
  geom_text(aes(label=paste0(round(prop,1),"%")),size =9, position=position_stack(vjust=0.5)) +
  theme_classic()+
  theme(legend.position = "bottom")+
  theme(legend.title=element_blank())+
  theme(text=element_text(family="serif", size=25))+
...
#combine files to one 
whole_allreadslength <- rbind(all_readslength4,all_readslength5,all_readslength6)#,all_readslength1,all_readslength2,all_readslength3,all_readslength7,all_readslength8)
   #removes unused data, to save RAM capacity
          rm(all_readslength4,all_readslength5,all_readslength6)#,all_readslength1,all_readslength2,all_readslength3,all_readslength7,all_readslength8)
...
#combine files to one 
#whole_dorado_readslength <- rbind(dorado_readslength4,dorado_readslength5,dorado_readslength6)#,dorado_readslength1,dorado_readslength2,dorado_readslength3,dorado_readslength7,dorado_readslength8)
   #removes unused data, to save RAM capacity
#    rm(dorado_readslength4,dorado_readslength5,dorado_readslength6)#,dorado_readslength1,dorado_readslength2,dorado_readslength3,dorado_readslength7,dorado_readslength8)
...
#combine files to one 
whole_HG38_readslength <- rbind(HG38_readslength4,HG38_readslength5,HG38_readslength6)#,HG38_readslength1,HG38_readslength2,HG38_readslength3,HG38_readslength7,HG38_readslength8)
  #removes unused data, to save RAM capacity
    rm(HG38_readslength4,HG38_readslength5,HG38_readslength6)#,HG38_readslength1,HG38_readslength2,HG38_readslength3,HG38_readslength7,HG38_readslength8)
...
#combine files to one 
whole_nonalign_readslength <- rbind(nonalign_readslength4,nonalign_readslength5,nonalign_readslength6)#,nonalign_readslength1,nonalign_readslength2,nonalign_readslength3,nonalign_readslength7,nonalign_readslength8)

  #removes unused data, to save RAM capacity
    rm(nonalign_readslength4,nonalign_readslength5,nonalign_readslength6)#,nonalign_readslength1,nonalign_readslength2,nonalign_readslength3,nonalign_readslength7,nonalign_readslength8)
...
```{r} 
##png
#png(filename="002_Overview.png", width =2910, height = 2755, units = "px") 
#((FOXP3_v | whole_v | whole_zoom_v ) /
...
png(file="002_Poly(A) length Overview.png", width =1400, height = 1800, units = "px") 
((FOXP3_v | whole_v) /
(FOXP3_counts | whole_counts)+
plot_annotation(tag_levels = 'A'))
dev.off()

png(file="002_read length Overview.png", width =1400, height = 1800, units = "px") 
