...
FOXP3_length$sample <- factor(FOXP3_length$sample,
                              levels=c("Cases-Treg-HD2","Cases-HD3-Treg-3"))#,"Cases_Tconv-7","Cases-HD3-Treg-6","Cases-Treg-5"))
...
whole_FOXP3_readslength$sample <- factor(whole_FOXP3_readslength$sample,
                              levels=c("Cases-Treg-HD2","Cases-HD3-Treg-3"))#,"HD42_Lib1","HD42_Lib2","HD43"))#,"Cases_Tconv-7","Cases-HD3-Treg-6","Cases-Treg-5"))
...
FOXP3_readslength_v <- ggplot(whole_FOXP3_readslength, 
                  ...
                  #stat_summary(fun=mean, geom="text", aes(label=round(..y.., 1)), vjust=-0.5, size=4, col="red") + #shows average in plot!
                  #stat_summary(fun=median, geom="text", aes(label=round(..y.., 1)), vjust=-1.5, size=4, col="blue") + #shows median in plot
...
```{r} 
##png
#png(filename="sample Overview.png", width =2200, height = 1900, units = "px") 
#(((FOXP3_v | whole_v | whole_zoom_v ) + 
...
png(file="004_Poly(A) length Overview.png", width =1400, height = 1800, units = "px") 
((FOXP3_v | whole_v)/
((FOXP3_counts | whole_counts)+
   plot_layout(guides ="collect")&
            theme(legend.position = 'bottom',
...
png(file="004_read length Overview.png", width =1400, height = 1800, units = "px") 
